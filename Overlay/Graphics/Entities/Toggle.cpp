...
void Toggle::Draw()
{
	...
	DrawText( Toggle::ParentPos.x + Toggle::Pos.x + (Toggle::Size.x) + 3, Toggle::ParentPos.y + Toggle::Pos.y - (Toggle::Size.y / 8), Toggle::Name + std::to_wstring(GetParent()->Container().size()), "Verdana", 12, Colour(255, 255, 255, 255), None);
