...
namespace winrt::WidgetSampleCX::implementation
{
    using IXamlMember = ::winrt::Windows::UI::Xaml::Markup::IXamlMember;
    using IXamlType = ::winrt::Windows::UI::Xaml::Markup::IXamlType;

    struct XamlMetaDataProvider : public ::winrt::WidgetSampleCX::implementation::XamlMetaDataProvider_base<XamlMetaDataProvider>
    {
...
namespace winrt::WidgetSampleCX::factory_implementation
{
